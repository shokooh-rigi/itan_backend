...
class VbsSheetForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(VbsSheetForm, self).__init__(*args, **kwargs)
...
class VbsSheetEquipmentForm(ModelForm):
    class Meta:
        model = VbsEquipment
        fields = [
            'sheet',
    ...
    def __init__(self, *args, **kwargs):
        super(VbsSheetEquipmentForm, self).__init__(*args, **kwargs)
        for visible in self.visible_fields():
            visible.field.widget.attrs['class'] = 'form-control'
        for field in self.fields.values():
            field.error_messages = {'required': '{fieldname} field is required'.format(fieldname=field.label)}
