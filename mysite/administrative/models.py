...
class Document(models.Model):
    ...
    customer = models.ForeignKey(Person, on_delete=models.SET_NULL, blank=False, null=True, related_name='doc_customer'
    ...
    def __str__(self):
        return self.customer.company.name + ': ' + self.type.name
