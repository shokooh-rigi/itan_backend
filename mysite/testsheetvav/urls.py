...
urlpatterns = [
    ...
    path('vav/equipments_generate_tech_pdf/<int:sheet_id>/', views.equipments_generate_tech_pdf, name='vavSheetEquipmentsGenerateTechPDF'),
    path('vav/equipments_generate_report_pdf/<int:sheet_id>/', views.equipments_generate_report_pdf, name='vavSheetEquipmentsGenerateReportPDF'),
    path('vav/equipments_list/<int:sheet_id>/', views.vav_sheet_equipment_list, name='vavSheetEquipmentList'),
    path('vav/sort_equipments_list/<int:sheet_id>/', views.sort_vav_sheet_equipment_list, name='sortVavEquipmentsList'),
    path('vav/sort_equipments/<int:sheet_id>/', views.update_sheet_equipments_positioning, name='vavSortEquipments'),
