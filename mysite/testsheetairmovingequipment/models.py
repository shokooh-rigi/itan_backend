...
class AirMovingEquipmentEquipment(models.Model):
...
class AirMovingEquipmentSheetData(models.Model):
    data_type = models.PositiveSmallIntegerField(choices=DataTypeChoices.get_items(), default=1, null=False)
    air_moving_equipment_equipment = models.ForeignKey(AirMovingEquipmentEquipment, on_delete=models.CASCADE, blank=False, null=False)
