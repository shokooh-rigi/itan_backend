...
class PitotTraverseEquipment(models.Model):
...
class PitotTraverseSheetData(models.Model):
    data_type = models.PositiveSmallIntegerField(choices=DataTypeChoices.get_items(), default=1, null=False)
    pitot_traverse_summary_equipment = models.ForeignKey(PitotTraverseEquipment, on_delete=models.CASCADE, blank=False, null=False)
