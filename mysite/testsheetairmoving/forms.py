...
class AirMovingEquipmentSheetForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(AirMovingEquipmentSheetForm, self).__init__(*args, **kwargs)
...
class AirMovingEquipmentSheetEquipmentForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(AirMovingEquipmentSheetEquipmentForm, self).__init__(*args, **kwargs)
        for visible in self.visible_fields():
            visible.field.widget.attrs['class'] = 'form-control'
        for field in self.fields.values():
            field.error_messages = {'required': '{fieldname} field is required'.format(fieldname=field.label)}
