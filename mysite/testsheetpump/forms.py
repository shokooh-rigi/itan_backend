...
class PumpSheetForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(PumpSheetForm, self).__init__(*args, **kwargs)
...
class PumpSheetEquipmentForm(ModelForm):
    class Meta:
        model = PumpEquipment
        fields = [
            'sheet',
    ...
    def __init__(self, *args, **kwargs):
        super(PumpSheetEquipmentForm, self).__init__(*args, **kwargs)
        for visible in self.visible_fields():
            visible.field.widget.attrs['class'] = 'form-control'
        for field in self.fields.values():
            field.error_messages = {'required': '{fieldname} field is required'.format(fieldname=field.label)}
