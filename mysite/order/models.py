...
class Order(models.Model):
    ...
    date_po_received = models.DateField(default=datetime.datetime.now().strftime("%m/%d/%Y"), blank=False)
    estimated_date_of_project = models.DateField(default=datetime.datetime.now().strftime("%m/%d/%Y"), blank=False)
