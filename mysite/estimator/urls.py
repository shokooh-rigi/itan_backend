...
urlpatterns = [
    ...
    url(r'^custromer_person/create', views.customer_person_create_popup, name="customerPersonCreate"),
    url(r'^custromer_person/(?P<pk>\d+)/edit', views.customer_person_edit_popup, name="customerPersonEdit"),
    url(r'^engineer_person/create', views.engineer_person_create_popup, name="engineerPersonCreate"),
    url(r'^engineer_person/(?P<pk>\d+)/edit', views.engineer_person_edit_popup, name="engineerPersonEdit"),
