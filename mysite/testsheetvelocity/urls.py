...
urlpatterns = [
    ...
    path('velocity/add_equipment/<int:sheet_id>/<int:sheet_equipment_id>/', views.velocity_add_equipment, name='velocityAddEquipment'),
    path('velocity/equipment_actual_value/<int:sheet_id>/<int:velocity_equipment_id>/', views.velocity_actual_data, name='velocityActualData'),
