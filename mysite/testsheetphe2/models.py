...
class PHE2Equipment(models.Model):
...
class PHE2SheetData(models.Model):
    data_type = models.PositiveSmallIntegerField(choices=DataTypeChoices.get_items(), default=1, null=False)
    primary_heat_exchanger_2_equipment = models.ForeignKey(PHE2Equipment, on_delete=models.CASCADE, blank=False, null=False)
